...
async function ConnectionComplet(player) {
    if (await LocalStorage.get('WebLanguage') == null) LocalStorage.set('WebLanguage', "en")
    if (await LocalStorage.get('WebDarkMode') == null) LocalStorage.set('WebDarkMode', false)
    if (await LocalStorage.get('Remember') == null) LocalStorage.set('Remember', false)
    if (await LocalStorage.get("Chat_TimeStamp") == null) await LocalStorage.set("Chat_TimeStamp", false)
